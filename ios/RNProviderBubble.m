...
RCT_EXTERN_METHOD(setupProviderContext : (NSString *)id token:(NSString *)token status:(NSString *)status redisURI:(NSString *)redisURI changeStateURL:(NSString *)changeStateURL pingURL:(NSString *)pingURL  pingSeconds:(NSString *)pingSeconds receivedUrl:(NSString *)receivedUrl isCheckTimeEnable:(BOOL *)isCheckTimeEnable isSynchronousAckEnabled:(BOOL *)isSynchronousAckEnabled)
